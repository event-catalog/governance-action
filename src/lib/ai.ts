...
const AiResponseSchema = z.object({
  ...
  detailedAnalysis: z.string().describe("A comprehensive breakdown of the review, including specific issues, backward-compatibility impact, domain concerns, adherence to EDA rules, and other architectural notes. This section should be thorough and professional."),
  recommendations: z.string().describe("Actionable recommendations to address identified issues or affirm good practices. Each recommendation should be clear and direct."),
